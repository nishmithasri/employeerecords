					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#employeerecords-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"employeerecords-display": {
								"semanticObject": "employeerecords",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeerecords",
									"url": sap.ui.require.toUrl("employeerecords")
								}
							}
						}
					}
